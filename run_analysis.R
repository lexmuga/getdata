...
##      Fast aggregation of large data, fast ordered joins, 
##      fast add/modify/delete of columns by group using no 
##      copies at all, list columns and a fast file reader (fread). 
...
##
##      The 561 variables are given below:
#          1 tBodyAcc-mean()-X
#          2 tBodyAcc-mean()-Y
#          3 tBodyAcc-mean()-Z
#          4 tBodyAcc-std()-X
...
##      The 6 activity labels are given below:
##       1 WALKING
##       2 WALKING_UPSTAIRS
...
##      dimension       : 33 x 2
##
##      The 33 mean measurement variables with 
##      their respective column numbers in the data.frame
#         1    1           tBodyAcc-mean()-X
#         2    2           tBodyAcc-mean()-Y
#         3    3           tBodyAcc-mean()-Z
...
##      dimension       : 33 x 2
##
##      The 33 measures of the standard deviation with
##      their respective column numbers in the data.frame
#         1    4           tBodyAcc-std()-X
#         2    5           tBodyAcc-std()-Y
#         3    6           tBodyAcc-std()-Z
...
d2names <- gsub("[.]","",names(data2))
setnames(data2, names(data2), d2names)
...
##      The column names are cleaned by removing the "." characters.
###################################################################
